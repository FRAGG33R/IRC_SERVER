SRC_FILE = main.cpp src/Client.cpp src/Channel.cpp src/Server.cpp src/Error.cpp src/Parsing.cpp src/Parser.cpp src/Registration.cpp src/Commands.cpp src/Privmsg.cpp src/Join.cpp
